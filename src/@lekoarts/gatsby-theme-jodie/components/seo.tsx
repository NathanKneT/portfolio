...
const SEO = ({ description = ``, meta = [], pathname = ``, image = ``, title = `` }: SEOProps) => {
  ...
  const professionalServiceSchema = {
    ...
    "name": "Nathan RIHET Photography",
    "image": "https://nathanglhf.com/banner.jpg",
    "description": "Professional photographer based in Tokyo, specializing in portrait, urban cinematic and event photography.",
    "url": "https://nathanglhf.com",
    "telephone": "070-8544-6481", 
    "address": {
      "@type": "PostalAddress",
    ...
    "sameAs": [
      "https://instagram.com/nathanglhf"
